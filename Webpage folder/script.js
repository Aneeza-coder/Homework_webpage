...
// 1. Today's Special Button
document.getElementById("specialBtn").addEventListener("click", function () {
    document.getElementById("specialText").innerHTML = "Today's Special: Chicken Tikka Biryani with 20% OFF! 🔥";
});
...
function upDate(previewPic) {
    ...
    document.getElementById("image").style.lineHeight = "280px";
}

function unDo() {
    document.getElementById("image").style.backgroundImage = "none";
    document.getElementById("image").innerHTML = "Hover over a food image to display it here.";
    document.getElementById("image").style.color = "white";
    document.getElementById("image").style.lineHeight = "200px";
}